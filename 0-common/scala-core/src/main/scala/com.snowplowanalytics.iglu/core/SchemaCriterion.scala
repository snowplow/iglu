...
case class SchemaCriterion(
   ...
   *           an [[SelfDescribed]] instance in scope
   * @return list of matching entities
   */
  def pickFrom[E: SelfDescribed](entities: Seq[E]): Seq[E] =
...
object SchemaCriterion {
   ...
   */
  val criterionRegex = "^iglu:([a-zA-Z0-9-_.]+)/([a-zA-Z0-9-_]+)/([a-zA-Z0-9-_]+)/([0-9]+|\\*)-([0-9]+|\\*)-([0-9]+|\\*)$".r
