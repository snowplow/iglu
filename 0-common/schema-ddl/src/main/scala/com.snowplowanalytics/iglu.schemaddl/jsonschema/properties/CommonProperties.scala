...
object CommonProperties {
  ...
  /**
    ...
    *
    * @see http://json-schema.org/latest/json-schema-validation.html#rfc.section.6.7.2
    */
  case class AnyOf(value: List[Schema]) extends JsonSchemaProperty { def keyName = "anyOf" }
