...
object SchemaActor {
   ...
   * @param permission API key's permission
   */
  case class GetPublicSchemas(owner: String, permission: String, includeMetadata: Boolean = false)
  ...
  case class GetSchemasFromFormat(vendors: List[String], names: List[String],
    formats: List[String], owner: String, permission: String, includeMetadata: Boolean = false)
  ...
  case class GetSchemasFromName(vendors: List[String], names: List[String],
    owner: String, permission: String, includeMetadata: Boolean = false)
